...
export default function BrandNotFound() {
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-center gap-4 px-4 py-24 text-center">
      ...
      <Link
        href="/"
        className="mt-2 inline-flex w-fit items-center gap-2 rounded-full border border-zinc-700 px-4 py-2 text-xs font-medium uppercase tracking-wide text-zinc-300 transition-colors hover:border-white hover:text-white"
      >
        ← Retour aux marques
      </Link>
    </main>
